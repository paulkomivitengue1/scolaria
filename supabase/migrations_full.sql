-- ═══════════════════════════════════════════════════════════
-- GESTILYS — MIGRATION CONSOLIDÉE (à exécuter sur le projet tzykjwsezuojwclqnqoh)
-- ═══════════════════════════════════════════════════════════
-- Ce fichier regroupe les 5 migrations en un seul script.
-- Copiez-collez l'intégralité dans le SQL Editor du dashboard Supabase
-- du projet tzykjwsezuojwclqnqoh et cliquez sur "Run".
-- ═══════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════
REVOKE EXECUTE ON FUNCTION current_school_id() FROM anon, authenticated, PUBLIC;
REVOKE EXECUTE ON FUNCTION handle_new_school(text, text, text) FROM anon, PUBLIC;
...
-- ══════════════════════════════════════════════════════════
-- Refresh PostgREST schema cache so the function is immediately
-- discoverable by the REST API
-- ══════════════════════════════════════════════════════════
